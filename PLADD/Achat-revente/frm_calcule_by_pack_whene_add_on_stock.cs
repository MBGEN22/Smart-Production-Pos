...
{
    public partial class frm_calcule_by_pack_whene_add_on_stock : Form
    {
        public PLADD.Achat_revente.frm_add_on_Stock add_achat;
        public frm_calcule_by_pack_whene_add_on_stock()
        {
            InitializeComponent();
        }
