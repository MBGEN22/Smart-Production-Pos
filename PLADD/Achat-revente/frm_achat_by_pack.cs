...
{
	public partial class frm_achat_by_pack : Form
	{
		public PLADD.Achat_revente.frm_add_achat add_achat;
	 
		public frm_achat_by_pack()
		{
			InitializeComponent();
		}
		...
		private void txt_achat_ht_pack_TextChanged(object sender, EventArgs e)
		{
		...
		private void radioButton1_CheckedChanged(object sender, EventArgs e)
		{
			...
			{
				price_achat_HT.Text =
				CalculePrice_u(decimal.Parse(txt_achat_ht_pack.Text), decimal.Parse(nmbre_u_dans_pack.Text)).ToString();
				price_achat_TTC.Text =
				CalculePrice_u(decimal.Parse(txt_achat_ttc_pack.Text), decimal.Parse(nmbre_u_dans_pack.Text)).ToString();
			}
			else if (radioButton2.Checked == true)
			{
				price_achat_HT.Text =
				CalculePrice_u(decimal.Parse(Total_HT_pack.Text), decimal.Parse(Qt_total_of_product.Text)).ToString();
				price_achat_TTC.Text =
				CalculePrice_u(decimal.Parse(Total_TTC_pack.Text), decimal.Parse(Qt_total_of_product.Text)).ToString();
			}
		}
        ...
        private void price_achat_HT_TextChanged(object sender, EventArgs e)
        {
        ...
        private void price_achat_TTC_TextChanged(object sender, EventArgs e)
        {

        }

        private void Qt_total_of_product_TextChanged(object sender, EventArgs e)
        {
