namespace Smart_Production_Pos.PLADD.Fichier
{
	partial class frm_add_marque
	{
		...
		private void InitializeComponent()
		{
			...
			// kryptonButton1
			// 
			this.kryptonButton1.Location = new System.Drawing.Point(9, 68);
			...
			// txt_Stocke
			// 
			this.txt_Stocke.Location = new System.Drawing.Point(109, 15);
			...
			this.Name = "frm_add_marque";
			this.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
			this.RightToLeftLayout = true;
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "تسيير العلامات";
