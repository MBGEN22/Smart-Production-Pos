namespace Smart_Production_Pos.PLADD.Fichier
{
	partial class frm_add_Stockes
	{
		...
		private void InitializeComponent()
		{
			...
			// txt_Stocke
			// 
			this.txt_Stocke.Location = new System.Drawing.Point(112, 11);
			...
			this.txt_Stocke.TabIndex = 5;
			// 
			// kryptonButton1
			// 
			this.kryptonButton1.Location = new System.Drawing.Point(12, 64);
			...
			this.Name = "frm_add_Stockes";
			this.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
			this.RightToLeftLayout = true;
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "تسيير المخازن";
