...
{
	public partial class frm_add_commande : Form
	{
		...
		BL.Bl_commande.bl_dechet_non_recycle class_Dechet_non = new bl_dechet_non_recycle();
		string delte;
		...
		#region form
		private static frm_add_commande frm;
		static void frm_formClosed(Object sender, FormClosedEventArgs e)
		{
			frm = null;
		}

		public static frm_add_commande getMainForm
		{
			get
			{
				if (frm == null)
				{
					frm = new frm_add_commande();
		...
		private void frm_add_commande_Load(object sender, EventArgs e)
		{
		...
		private void button2_Click_1(object sender, EventArgs e)
		{
			...
			add_divers.id_type_edit_or_add = 1;
			add_divers.formComande = this;
		...
		public void txt_prix_unite_TextChanged(object sender, EventArgs e)
		{
		...
		private void check_deadline_CheckedChanged(object sender, EventArgs e)
		{
		...
		public void insert_dechet_non_recycle()
		{
			...
			foreach (DataGridViewRow row in grid_matier.Rows)
			{
				if (!row.IsNewRow)
				{
					...
					if (use == "لا")
					{
						class_Dechet_non.insert_dechet(idProduit, qt_dechet, etas, price_u, Cout_dechet);
					}
				}
			}
		}
		...
		private void grid_tools_CellContentClick(object sender, DataGridViewCellEventArgs e)
		{
		...
		private void checkBox10_ChevenceckedChanged(object sender, EventArgs e)
		{
			decimal total = decimal.Parse(txt_ttl_ttc.Text);
			decimal avance = decimal.Parse(txtCredit.Text);
		...
		private void txt_prix_unite_KeyPress(object sender, KeyPressEventArgs e)
		{
		...
		private void qt_dechet_KeyPress(object sender, KeyPressEventArgs e)
		{
			if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar) && e.KeyChar != ',' && e.KeyChar != '.')
			{
				e.Handled = true; // Prevent the character from being entered
		...
		private void txt_prix_total_TextChanged(object sender, EventArgs e)
		{

		}

		private void checkBocx10_ChevenceckedChanged(object sender, EventArgs e)
		{
		...
		private void txtCredivt_KeyPress(object sender, KeyPressEventArgs e)
		{
