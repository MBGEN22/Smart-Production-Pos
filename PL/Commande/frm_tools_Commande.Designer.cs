...
{
	partial class frm_tools_Commande
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.grid_sub_commande.Size = new System.Drawing.Size(647, 380);
			...
			this.Name = "frm_tools_Commande";
			this.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
			this.RightToLeftLayout = true;
			this.ShowIcon = false;
			this.ShowInTaskbar = false;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "الالات والأدوات";
			this.Load += new System.EventHandler(this.frm_tools_Commande_Load);
